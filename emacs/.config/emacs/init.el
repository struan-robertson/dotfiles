...
(custom-set-variables
 ...
 '(package-selected-packages
   '(flymake-proselint writegood-mode vertico orderless corfu multiple-cursors auctex eat which-key magit nano-theme expand-region no-littering vc-use-package))
