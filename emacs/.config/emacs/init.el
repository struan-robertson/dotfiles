...
(custom-set-variables
 ...
 '(package-selected-packages
   '(use-package-ensure-system-package vertico orderless corfu multiple-cursors auctex eat which-key magit nano-theme expand-region no-littering vc-use-package))
