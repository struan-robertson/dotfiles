...
(custom-set-faces
 ...
 '(avy-lead-face-0 ((t (:background "#d08770"))))
 '(avy-lead-face-1 ((t (:background "#ebcb8b"))))
 '(avy-lead-face-2 ((t (:background "#b48ead" :foreground "white"))))
 '(bold ((t (:inherit nano-strong :weight medium))))
 '(circe-highlight-nick-face ((t (:foreground "#b48ead" :weight bold))))
 '(circe-originator-face ((t (:foreground "#81a1c1"))))
 '(circe-prompt-face ((t (:foreground "#81A1C1" :weight bold))))
 '(circe-server-face ((t (:foreground "#4c566a"))))
 ...
 '(lui-button-face ((t (:foreground "#5e81ac" :underline t))))
 '(lui-highlight-face ((t (:foreground "#8fbcbb"))))
 ...
 '(sh-heredoc ((t (:foreground "#ebcb8b" :weight bold))))
 ...
 '(smerge-refined-removed ((t (:inherit smerge-refined-change :background "#2e3440"))))
