...
(custom-set-faces
 ...
 '(smerge-refined-added ((t (:inherit smerge-refined-change :background "#a3be8c" :foreground "#2e3440"))))
 '(smerge-refined-removed ((t (:inherit smerge-refined-change :background "#bf616a" :foreground "#2e3440"))))
 '(smerge-upper ((t (:extend t :foreground "#bf616a"))))
 '(term-color-black ((t (:background "#3b4252" :foreground "#3b4252"))))
 '(term-color-blue ((t (:background "#5e81ac" :foreground "#5e81ac"))))
 '(term-color-bright-black ((t (:background "#4c566a" :foreground "#4c566a"))))
 '(term-color-bright-blue ((t (:background "#81a1c1" :foreground "#81a1c1"))))
 ...
 '(vterm-color-bright-cyan ((t (:inherit term-color-cyan))))
 '(vterm-color-bright-green ((t (:inherit term-color-green))))
 '(vterm-color-bright-magenta ((t (:inherit term-color-magenta))))
 '(vterm-color-bright-red ((t (:inherit term-color-red))))
 '(vterm-color-bright-yellow ((t (:inherit term-color-yellow))))
